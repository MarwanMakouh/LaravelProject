...
@section('title', 'Artikel Bewerken - Admin - GamePortal')
...
<div class="create-container">
    <div class="create-header">
        <h1>✏️ Artikel Bewerken</h1>
        <p>Bewerk je nieuwsartikel</p>
    </div>

    <form action="{{ route('admin.news.update', $newsItem->id) }}" method="POST" class="create-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input
                ...
                maxlength="500"
                value="{{ old('image_url', $newsItem->image_url) }}"
            >
